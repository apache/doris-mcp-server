...
from doris_mcp_client.client import DorisClientConfig, DorisUnifiedClient
...
class TestConfigLoader:
    ...
    def create_client(self, transport: str | None = None) -> DorisUnifiedClient:
...
def create_test_client(transport: str | None = None) -> DorisUnifiedClient:
    """Create test client with default configuration"""
    return get_test_config().create_client(transport)


async def test_server_connectivity(transport: str | None = None) -> bool:
