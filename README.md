...
| `get_table_summary`         | Get table summary information.                              | `table_name` (string, Required), `db_name` (string, Required), `include_sample` (boolean, Optional), `sample_size` (integer, Optional)  |
